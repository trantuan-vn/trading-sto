...
export function createVoucherRoutes(bindingName: string) {
  ...
  app.post('/vouchers', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to create voucher');
  ...
  app.post('/apply/service', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to apply voucher to service');
      return c.json(errorResponse, status);
    }
  });
  ...
  app.post('/apply/user', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to apply voucher to user');
      return c.json(errorResponse, status);
    }
  });
  ...
  app.get('/vouchers', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to get vouchers');
      return c.json(errorResponse, status);
    }
  });
  ...
  app.get('/code/:voucherCode', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to get voucher');
      return c.json(errorResponse, status);
    }
  });
  ...
  app.post('/validate/service', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to validate service voucher');
      return c.json(errorResponse, status);
    }
  });
  ...
  app.post('/validate/user', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to validate user voucher');
      return c.json(errorResponse, status);
    }
  });
  ...
  app.patch('/vouchers/:voucherId/status', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to update voucher status');
      return c.json(errorResponse, status);
    }
  });
  ...
  //     return c.json(result);
  //   } catch (e) {
  //     const { errorResponse, status } = await handleError(c, e, 'Failed to get voucher usage');
  //     return c.json(errorResponse, status);
  //   }
  // });
  ...
  app.get('/available/services', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to get available service vouchers');
      return c.json(errorResponse, status);
    }
  });
  ...
  app.get('/available/users', async (c) => {
    try {
      ...
      const { errorResponse, status } = await handleError(c, e, 'Failed to get available user vouchers');
      return c.json(errorResponse, status);
    }
  });
